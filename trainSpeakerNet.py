...
parser.add_argument('--batch_size',     type=int,   default=256,    help='Batch size, number of speakers per batch')
...
parser.add_argument('--model',          type=str,   default="DTDy_ResNet34_half",     help='Name of model definition')
